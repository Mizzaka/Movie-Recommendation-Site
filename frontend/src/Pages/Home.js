    ...
    <>
      ...
      >
        ...
        <img 
          ...
          <p className="absolute mt-32 top-24 left-10 text-white text-2xl   bg-opacity-100 p-2 ">2017</p>
          <p className="absolute mt-36 top-28 left-10 text-white text-lg   bg-opacity-100 p-2 ">Sci-fi/Action</p>
          <button className=" absolute left-12 -mt-16 bg-secondary px-6 py-2 rounded-xl shadow-2xl hover:bg-yellow-600 ">Watch</button>
          </div>  
