    ...
    >
      ...
      <div className="border -mt-40 text-white p-4 mx-5 mr-0">
        ...
        <div className="flex space-x-8 mx-4 mt-10">
          <button
            className={`pb-2 ${
              activeTab === "Movies" ? "border-b-2 border-white" : ""
            }`}
          ...
          <button
            className={`pb-2 ${
              activeTab === "Tv Series" ? "border-b-2 border-white" : ""
            }`}
          ...
          {movies.map((movie, index) => (
            <React.Fragment key={index}>
              ...
              <div className=" col-span-2">
                <h1 className="px-6 py-3 text-2xl font-poppins font-semibold">
                  Oppenheimer
                </h1>
                <h1 className="px-6 py-2 text-xl font-poppins font-semibold">
                  2023
                </h1>
                <div className="flex justify-start items-center">
                  ...
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    className="w-6 h-6 text-primary -mx-4 -mt-1"
                  >
                    <path
                      fillRule="evenodd"
                ...
                <h1 className="px-6 py-2 font-poppins font-medium text-gray-300">
                  Trending 1
                </h1>
              </div>
            </React.Fragment>
